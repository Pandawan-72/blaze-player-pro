...
public abstract class Hilt_AudioPlayerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AudioPlayerFragment() {
    super();
  }

  Hilt_AudioPlayerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AudioPlayerFragment_GeneratedInjector) this.generatedComponent()).injectAudioPlayerFragment(UnsafeCasts.<AudioPlayerFragment>unsafeCast(this));
    }
  }
