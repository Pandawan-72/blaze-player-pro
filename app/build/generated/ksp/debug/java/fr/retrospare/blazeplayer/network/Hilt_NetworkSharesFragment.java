...
public abstract class Hilt_NetworkSharesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NetworkSharesFragment() {
    super();
  }

  Hilt_NetworkSharesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NetworkSharesFragment_GeneratedInjector) this.generatedComponent()).injectNetworkSharesFragment(UnsafeCasts.<NetworkSharesFragment>unsafeCast(this));
    }
  }
