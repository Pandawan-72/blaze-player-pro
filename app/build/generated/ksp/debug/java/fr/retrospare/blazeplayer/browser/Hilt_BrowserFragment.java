...
public abstract class Hilt_BrowserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BrowserFragment() {
    super();
  }

  Hilt_BrowserFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BrowserFragment_GeneratedInjector) this.generatedComponent()).injectBrowserFragment(UnsafeCasts.<BrowserFragment>unsafeCast(this));
    }
  }
