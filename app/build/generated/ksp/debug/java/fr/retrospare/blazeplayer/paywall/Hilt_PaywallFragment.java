...
public abstract class Hilt_PaywallFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PaywallFragment() {
    super();
  }

  Hilt_PaywallFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PaywallFragment_GeneratedInjector) this.generatedComponent()).injectPaywallFragment(UnsafeCasts.<PaywallFragment>unsafeCast(this));
    }
  }
