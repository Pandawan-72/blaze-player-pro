...
public final class ItemMediaFileGridBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ItemMediaFileGridBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemMediaFileGridBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_media_file_grid, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemMediaFileGridBinding bind(@NonNull View rootView) {
