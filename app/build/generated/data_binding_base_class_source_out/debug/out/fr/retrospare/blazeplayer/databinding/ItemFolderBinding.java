...
public final class ItemFolderBinding implements ViewBinding {
  ...
  private ItemFolderBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnFolderMore,
  ...
  public static ItemFolderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFolderBinding((LinearLayout) rootView, btnFolderMore, checkWatchedFolder,
